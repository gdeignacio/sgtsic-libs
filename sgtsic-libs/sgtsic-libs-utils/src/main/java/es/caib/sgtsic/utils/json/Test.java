...
/**
 * Test class. This file is not formally a member of the es.bitel.utils.json library.
 ...
 */
        ...
        try {     
            j = XML.toJSONObject("<![CDATA[This is a collection of test patterns and examples for es.bitel.utils.json.]]>  Ignore the stuff past the end.  ");
